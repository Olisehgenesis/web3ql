 ...
 *  This is done entirely off-chain in the web3ql SDK crypto module.
 *
 * Security:
 ...
 *
 * @dev UUPS-upgradeable proxy. Only the owner can authorise upgrades.
 */
contract PublicKeyRegistry is
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
